...
with_node \
  ...
  --target "/Users/omsawant/Desktop/BundlwiseUI/ios/Pods/Target Support Files/Pods-bundlwise/ExpoModulesProvider.swift" \
  --entitlement "/Users/omsawant/Desktop/BundlwiseUI/ios/bundlwise/bundlwise.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient"
